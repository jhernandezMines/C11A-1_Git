...
public class Cat {
	...
	private static final int MOUTH_X = HEAD_DIMENSION/5 * 7;
	private static final int MOUTH_Y = HEAD_DIMENSION/5 * 7;
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		g2.drawString("YOWWLLLL", catX, catY+HEAD_DIMENSION+10);	
	}
}
